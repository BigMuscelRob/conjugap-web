...
const FEATURE_META = [
  { step: '01', icon: 'target', bg: 'bg-terracotta-500' },
  { step: '02', icon: 'keyboard', bg: 'bg-saffron-500' },
  { step: '03', icon: 'flame', bg: 'bg-sage-300' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {FEATURE_META.map((f, i) => (
            ...
            >
              ...
              <p className="text-[15px] leading-6 text-ink-700">{t(`items.${i}.body`)}</p>
            </div>
          ))}
        </div>
